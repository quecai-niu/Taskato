...
用户的通知偏好存储在以下文件：
`d:\Work\My\LearningMaterials\DotNET\WPF\code\Taskato\.agents\skills\skills\desktop-notification\resources\notification_config.txt`
...
```powershell
pwsh -NoProfile -WindowStyle Hidden -File "d:\Work\My\LearningMaterials\DotNET\WPF\code\Taskato\.agents\skills\skills\desktop-notification\scripts\notify.ps1"
```
